...
('Black Iris III', 'Fleur iconique, agrandie et détaillée, typique du modernisme américain.', 'Georgia O''Keeffe', 1926, '91.4cm x 75.9cm', 40000.00, 'images/okeeffe_blackiris3.jpg', 'disponible', 1, 1),
...
('Maman (Araignée)', 'Sculpture monumentale en bronze et acier inoxydable. Une version plus petite ou une étude pourrait être vendue.', 'Louise Bourgeois', 1999, 'H: 927cm (grande version)', 280000.00, 'images/bourgeois_maman.jpg', 'disponible', 2, 3),
...
('Mobile sur deux plans', 'Mobile en tôle d''acier peinte, jouant avec l''équilibre et le mouvement.', 'Alexander Calder', 1955, 'Variable', 5000.00, 'images/calder_mobile_deuxplans.jpg', 'disponible', 2, 2),
...
('Le Baiser de l''Hôtel de Ville', 'Photographie romantique d''un couple s''embrassant dans les rues de Paris.', 'Robert Doisneau', 1950, 'Tirage 30x40cm', 1550.00, 'images/doisneau_baiser_hoteldeville.jpg', 'disponible', 3, 1),
...
('Untitled Film Still #21', 'Autoportrait de l''artiste dans des mises en scène évoquant des films noirs.', 'Cindy Sherman', 1978, 'Tirage 20x25cm', 9000.00, 'images/sherman_filmstill21.jpg', 'disponible', 3, 2),

('Everydays: The First 5000 Days', 'Collage de 5000 images numériques créées quotidiennement, vendu comme NFT unique.', 'Beeple (Mike Winkelmann)', 2021, 'NFT (21069x21069px)', 693000.00, 'images/beeple_everydays.jpg', 'disponible', 4, 4),
...
('Hommage à Vera Molnar - Carrés (Variation)', 'Tirage numérique issu d''un programme informatique explorant les variations aléatoires de carrés. Édition limitée.', 'Artiste Contemporain (inspiré par Molnar)', 2022, 'Tirage pigmentaire 60x60cm', 3500.00, 'images/hommage_molnar_carres.jpg', 'disponible', 4, 3),
...
('No Title (Not a single spot of...', 'Dessin abstrait au crayon de couleur, typique de son style minimaliste.', 'Agnes Martin', 1967, 'Crayon et aquarelle sur papier 30x30cm', 3000.00, 'images/martin_nosinglespot.jpg', 'disponible', 5, 2),
...
('One (Number 31, 1950) - étude', 'Dessin préparatoire ou lié à ses grandes peintures "drip painting".', 'Jackson Pollock', 1950, 'Encre et gouache sur papier 57x78cm', 1000.00, 'images/pollock_etude_one.jpg', 'disponible', 5, 1),
